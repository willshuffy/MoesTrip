...
object MuseumData {
    ...
    private var data = arrayOf(
        ...
        arrayOf(
            ...
            "St.Gambir",
            "-",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/MuseumSumpahPemuda.jpg/800px-MuseumSumpahPemuda.jpg"
        ...
        arrayOf(
            ...
            "St.Gambir",
            "Bunderan HI",
            "https://cdn02.indozone.id/re/content/2019/12/06/d5s74y/t_5dea4f9758fb7.jpg?w=700&q=85"
            /*R.drawable.monas*/
        ),
        arrayOf(
            "Gedung Joang 45",
            ...
            "St.Gambir",
            "Bunderan HI",
            "https://upload.wikimedia.org/wikipedia/id/d/d0/Gedung_Joang_45.jpg"
        ...
        arrayOf(
            ...
            "https://upload.wikimedia.org/wikipedia/id/thumb/4/42/Meriam_tempur.JPG/800px-Meriam_tempur.JPG"
        ...
        arrayOf(
            ...
            "St.Jakarta Kota",
            "-",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a5/Museumbahari_Hariadhi.jpg/800px-Museumbahari_Hariadhi.jpg"
        ...
        arrayOf(
            ...
            "St.Gambir",
            "Dukuh Atas",
            "https://upload.wikimedia.org/wikipedia/id/0/0b/Napak_Tilas_Proklamasi.jpeg"
        ...
        arrayOf(
            ...
            "St.Jakarta Kota",
            "-",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Museum_Bank_Indonesia_2.jpg/800px-Museum_Bank_Indonesia_2.jpg"
        ...
        arrayOf(
            ...
            "St.Jakarta Kota",
            "-",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bc/Museum_Wayang.jpg/800px-Museum_Wayang.jpg"
        ...
        arrayOf(
            ...
            "-",
            "-",
            "https://www.indotelko.com/images/media/201806/ori/mustel.jpg"
    ...
    get() {
        ...
        for (isData in data){
            val museum = Museum()
            museum.name = isData[0]
            museum.address = isData[1]
            museum.detail = isData[2]
            museum.transjakarta = isData[3]
            museum.commuterline = isData[4]
            museum.trainstation = isData[5]
            museum.mrtstation = isData[6]
            museum.photo = isData[7]
